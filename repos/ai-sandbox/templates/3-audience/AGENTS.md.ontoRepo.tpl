...
This repo's behavior specs live in the prose repo: `prose/repos/infra/sandbox/spec/` (`.story.md` user stories by default, `.scenarios.md` Gherkin only for automation-bound behavior, status in each title, vetting dirs apply, edit specs before implementation).
